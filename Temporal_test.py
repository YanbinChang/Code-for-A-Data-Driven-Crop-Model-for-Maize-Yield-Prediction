...
#temporal Benchmark
temporal_Bench1 = [0 for i in range(40)]
...
for test_year in range(40):
    ...
    if test_year == 0:
        for test_county in County_FIPS:
            ...
            area = area_record[test_year][County_FIPS.index(test_county)] 
            yield_ob1 = mean([yield_record[1][County_FIPS.index(test_county)], yield_record[2][County_FIPS.index(test_county)]])
            obj_up += ((area)**2)*((yield_ob-yield_ob1)**2)
            obj_down += (area)**2
        temporal_Bench1[test_year] = (obj_up/obj_down)**0.5
    elif test_year == 39:
        for test_county in County_FIPS:
            yield_ob = yield_record[test_year][County_FIPS.index(test_county)]
            area = area_record[test_year][County_FIPS.index(test_county)] 
            yield_ob1 = mean([yield_record[37][County_FIPS.index(test_county)], yield_record[38][County_FIPS.index(test_county)]])
            obj_up += ((area)**2)*((yield_ob-yield_ob1)**2)
            obj_down += (area)**2
        temporal_Bench1[test_year] = (obj_up/obj_down)**0.5
        ...
        for test_county in County_FIPS:
            yield_ob = yield_record[test_year][County_FIPS.index(test_county)]
            area = area_record[test_year][County_FIPS.index(test_county)] 
            yield_ob1 = mean([yield_record[test_year-1][County_FIPS.index(test_county)], yield_record[test_year+1][County_FIPS.index(test_county)]])
            obj_up += ((area)**2)*((yield_ob-yield_ob1)**2)
            obj_down += (area)**2
        temporal_Bench1[test_year] = (obj_up/obj_down)**0.5
...
for year_exclude in range(40):
    ...
    if year_exclude == 0:
        seed_rue[0] = [(seed_rue[1][county_index] + seed_rue[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant[0] = [(seed_plant[1][county_index] + seed_plant[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_emerge[0] = [(seed_emerge[1][county_index] + seed_emerge[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_flower[0] = [(seed_flower[1][county_index] + seed_flower[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_grain[0] = [(seed_grain[1][county_index] + seed_grain[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_size[0] = [(seed_leaf_size[1][county_index] + seed_leaf_size[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate1[0] = [(seed_leaf_rate1[1][county_index] + seed_leaf_rate1[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate2[0] = [(seed_leaf_rate2[1][county_index] + seed_leaf_rate2[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_change[0] = [(seed_leaf_change[1][county_index] + seed_leaf_change[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_date[0] = [(seed_leaf_decline_date[1][county_index] + seed_leaf_decline_date[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_rate[0] = [(seed_leaf_decline_rate[1][county_index] + seed_leaf_decline_rate[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_water_supply_rate[0] = [(seed_water_supply_rate[1][county_index] + seed_water_supply_rate[2][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant_date[0] = [(seed_plant_date[1][county_index] + seed_plant_date[2][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_f[0]  = [(rue_rate_f[1][county_index] + rue_rate_f[2][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_g[0]  = [(rue_rate_g[1][county_index] + rue_rate_g[2][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_m[0] = [(rue_rate_m[1][county_index] + rue_rate_m[2][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_f[0] = [(water_uptake_rate_f[1][county_index] + water_uptake_rate_f[2][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_g[0]  = [(water_uptake_rate_g[1][county_index] + water_uptake_rate_g[2][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_m[0]  = [(water_uptake_rate_m[1][county_index] + water_uptake_rate_m[2][county_index])/2 for county_index in range(len(County_FIPS))]

    
    elif year_exclude == 39:
        seed_rue[39] = [(seed_rue[38][county_index] + seed_rue[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant[39] = [(seed_plant[38][county_index] + seed_plant[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_emerge[39] = [(seed_emerge[38][county_index] + seed_emerge[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_flower[39] = [(seed_flower[38][county_index] + seed_flower[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_grain[39] = [(seed_grain[38][county_index] + seed_grain[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_size[39] = [(seed_leaf_size[38][county_index] + seed_leaf_size[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate1[39] = [(seed_leaf_rate1[38][county_index] + seed_leaf_rate1[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate2[39] = [(seed_leaf_rate2[38][county_index] + seed_leaf_rate2[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_change[39] = [(seed_leaf_change[38][county_index] + seed_leaf_change[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_date[39] = [(seed_leaf_decline_date[38][county_index] + seed_leaf_decline_date[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_rate[39] = [(seed_leaf_decline_rate[38][county_index] + seed_leaf_decline_rate[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_water_supply_rate[39] = [(seed_water_supply_rate[38][county_index] + seed_water_supply_rate[37][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant_date[39] = [(seed_plant_date[38][county_index] + seed_plant_date[37][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_f[39]  = [(rue_rate_f[38][county_index] + rue_rate_f[37][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_g[39]  = [(rue_rate_g[38][county_index] + rue_rate_g[37][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_m[39] = [(rue_rate_m[38][county_index] + rue_rate_m[37][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_f[39] = [(water_uptake_rate_f[38][county_index] + water_uptake_rate_f[37][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_g[39]  = [(water_uptake_rate_g[38][county_index] + water_uptake_rate_g[37][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_m[39]  = [(water_uptake_rate_m[38][county_index] + water_uptake_rate_m[37][county_index])/2 for county_index in range(len(County_FIPS))]

    else:
        seed_rue[year_exclude] = [(seed_rue[year_exclude+1][county_index] + seed_rue[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant[year_exclude] = [(seed_plant[year_exclude+1][county_index] + seed_plant[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_emerge[year_exclude] = [(seed_emerge[year_exclude+1][county_index] + seed_emerge[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_flower[year_exclude] = [(seed_flower[year_exclude+1][county_index] + seed_flower[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_grain[year_exclude] = [(seed_grain[year_exclude+1][county_index] + seed_grain[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_size[year_exclude] = [(seed_leaf_size[year_exclude+1][county_index] + seed_leaf_size[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate1[year_exclude] = [(seed_leaf_rate1[year_exclude+1][county_index] + seed_leaf_rate1[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_rate2[year_exclude] = [(seed_leaf_rate2[year_exclude+1][county_index] + seed_leaf_rate2[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_change[year_exclude] = [(seed_leaf_change[year_exclude+1][county_index] + seed_leaf_change[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_date[year_exclude] = [(seed_leaf_decline_date[year_exclude+1][county_index] + seed_leaf_decline_date[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_leaf_decline_rate[year_exclude] = [(seed_leaf_decline_rate[year_exclude+1][county_index] + seed_leaf_decline_rate[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_water_supply_rate[year_exclude] = [(seed_water_supply_rate[year_exclude+1][county_index] + seed_water_supply_rate[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        seed_plant_date[year_exclude] = [(seed_plant_date[year_exclude+1][county_index] + seed_plant_date[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_f[year_exclude]  = [(rue_rate_f[year_exclude+1][county_index] + rue_rate_f[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_g[year_exclude]  = [(rue_rate_g[year_exclude+1][county_index] + rue_rate_g[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        rue_rate_m[year_exclude] = [(rue_rate_m[year_exclude+1][county_index] + rue_rate_m[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_f[year_exclude] = [(water_uptake_rate_f[year_exclude+1][county_index] + water_uptake_rate_f[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_g[year_exclude]  = [(water_uptake_rate_g[year_exclude+1][county_index] + water_uptake_rate_g[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
        water_uptake_rate_m[year_exclude]  = [(water_uptake_rate_m[year_exclude+1][county_index] + water_uptake_rate_m[year_exclude-1][county_index])/2 for county_index in range(len(County_FIPS))]
    
    
    
    temporal_test_result.append(compute_RMSE(Year_index[year_exclude]))
...
for i in range(40):
    temporal_training.append(compute_RMSE(Year_index[i]))
    
    
Year_name = [str(i+1981) for i in range(40)]
Year_area1 = [i/10000000/2.471 for i in Year_area]
plt.figure()  
plt.figure(figsize=(20, 8))

plt.bar(Year_name, Year_area1, color='limegreen', alpha=0.5, zorder=1)
plt.ylabel('Area planted ($10^7$ ha)', fontsize=15)
plt.xlabel('Year', fontsize=15)
plt.tick_params(axis='x', rotation=45)
#plt.plot(state_name, Spatial_Bench1, color='k', label='Benchmark', marker='o', zorder=2)
#plt.ylabel('RMSE (bu/ac)') 

temporal_Bench1_ha = [i*0.0628 for i in temporal_Bench1]
temporal_test_result_ha = [i*0.0628 for i in temporal_test_result]
temporal_training_ha = [i*0.0628 for i in temporal_training]

axes2 = plt.twinx()
axes2.plot(Year_name, temporal_Bench1_ha, color='k', label='Benchmark', marker='o', linewidth=2, markersize=8)
axes2.plot(Year_name, temporal_test_result_ha, color='r', label='Test', marker='^', linewidth=2, linestyle='dashed', markersize=8)
axes2.plot(Year_name, temporal_training_ha, color='b', label='Training', marker='s', linewidth=2, markersize=8)
#plt.xticks(rotation=90)
axes2.set_ylabel('RMSE (Mg/ha)', fontsize=15) 


axes2.legend(loc="upper left", fontsize=16)

#axes2.set_xlabel('Year', fontsize=16)



#plt.savefig('yield_temporal_test_0331.png', dpi=600, facecolor = 'white')
#plt.close()
